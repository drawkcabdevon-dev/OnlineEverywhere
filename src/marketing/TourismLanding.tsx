            ...
            <main className="max-w-7xl mx-auto px-6 pt-32 pb-24">
                ...
                <section className="mb-32 text-center lg:text-left">
                    <div className="max-w-4xl">
                        <span className="text-primary font-bold tracking-widest text-xs uppercase mb-4 block italic">Institutional Digital Transformation</span>
                        <h2 className="text-5xl md:text-8xl font-black leading-[1.1] tracking-tight mb-8">
                            Project Your Excellence into the <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-blue-400">Digital Universe.</span>
                        </h2>
                        <p className="text-slate-400 text-2xl leading-relaxed mb-12 max-w-2xl">
                            We bridge the gap between Caribbean potential and global demand. Our framework connects **Export Businesses and Tourism Partners** to high-value international audiences through institutional-grade digital maturity.
                        </p>
                    </div>
                </section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-32">
                    {[
                        {
                            title: "Global Export Dominance",
                            desc: "We don't just optimize for search; we optimize for international market penetration. Capture global demand at the exact moment intent enters the digital stream.",
                            icon: "travel_explore"
                        },
                        {
                            title: "Cross-Border Intelligence",
                            desc: "Deep-behavioral tracking across national boundaries. Understand how international traffic discovers, engages, and converts with your brand.",
                            icon: "query_stats"
                        },
                        {
                            title: "Digital Universe Mapping",
                            desc: "Tailoring technical infrastructure and psychological triggers to match the expectations of sophisticated global audiences.",
                            icon: "public"
                        }
                    ].map((item, i) => (
                ...
                <div className="rounded-[40px] bg-gradient-to-br from-primary/20 to-transparent border border-white/10 p-12 md:p-24 text-center">
                    <h2 className="text-4xl md:text-6xl font-black mb-8">Ready to Scale your Export?</h2>
                    <p className="text-slate-400 text-xl max-w-2xl mx-auto mb-12">
                        Our digital transformation framework is designed for manufacturers, exporters, and tourism leaders ready to claim their space in the digital universe.
                    </p>
