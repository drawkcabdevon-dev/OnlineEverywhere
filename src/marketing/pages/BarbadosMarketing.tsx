                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        <div className="lg:w-1/2">
                            ...
                            <h2 className="text-4xl lg:text-5xl font-display font-bold text-navy-deep leading-tight mb-6">
                                From Hidden Gem to <span className="text-google-blue">Search Leader.</span>
                            </h2>
                            <p className="text-lg text-gray-500 mb-8 leading-relaxed">
                                How <strong>Barbados ATV Adventure Co.</strong> transformed from a word-of-mouth excursion to the #1 booked off-road experience on the island.
                            </p>

                            <div className="space-y-8">
                                <div className="border-l-4 border-gray-200 pl-6">
                                    <h4 className="text-lg font-bold text-gray-900 mb-2">The Challenge</h4>
                                    <p className="text-gray-500 text-sm">Reliant on hotel desk referrals and brochure stands. No direct booking infrastructure, leading to 40% revenue leakage to third-party commissions.</p>
                                </div>
                                <div className="border-l-4 border-google-blue pl-6">
                                    <h4 className="text-lg font-bold text-gray-900 mb-2">The OLE Solution</h4>
                                    <ul className="space-y-3 text-sm text-gray-600">
                                        <li className="flex gap-3"><span className="material-symbols-outlined text-google-blue text-lg">check_circle</span> <strong>Infrastructure:</strong> Direct booking engine integration.</li>
                                        <li className="flex gap-3"><span className="material-symbols-outlined text-google-blue text-lg">check_circle</span> <strong>SEO Dominance:</strong> Ranked #1 for "Barbados Off-Road Tours".</li>
                                        <li className="flex gap-3"><span className="material-symbols-outlined text-google-blue text-lg">check_circle</span> <strong>High-Octane Content:</strong> Action-first video storytelling.</li>
                                        <li className="flex gap-3"><span className="material-symbols-outlined text-google-blue text-lg">check_circle</span> <strong>Strategic Retargeting:</strong> "The Loop" — Automated cross-sell offers to past riders (e.g., Catamaran partners).</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="lg:w-1/2 relative">
                            <div className="absolute inset-0 bg-gradient-to-br from-orange-500/20 to-google-red/20 rounded-[3rem] blur-3xl transform rotate-3"></div>
                            <div className="relative bg-white rounded-[2.5rem] shadow-2xl border border-gray-100 overflow-hidden">
                                <div className="p-8 bg-gray-900 relative overflow-hidden h-64 flex items-end">
                                    <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?auto=format&fit=crop&q=80')] bg-cover bg-center opacity-40"></div>
                                    <div className="absolute inset-0 bg-gradient-to-t from-gray-900 to-transparent"></div>
                                    <div className="relative z-10 w-full">
                                        <p className="text-orange-400 font-bold text-xs uppercase tracking-widest mb-1">Annual Revenue Growth</p>
                                        <div className="flex justify-between items-end">
                                            <h3 className="text-4xl text-white font-display font-bold">+300%</h3>
                                            <span className="bg-green-500/20 text-green-400 px-2 py-1 rounded text-xs font-bold">+125 New Bookings/mo</span>
                                        </div>
                                    </div>
                                </div>
                                <div className="p-8">
                                    <h4 className="font-bold text-navy-deep mb-4 flex items-center gap-2">
                                        <span className="material-symbols-outlined text-google-blue">campaign</span>
                                    ...
                                    <div className="space-y-4">
                                        <div>
                                            ...
                                            <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                                                <div className="h-full bg-google-blue w-[28%] rounded-full"></div>
                                            </div>
                                        </div>
                                        <div>
                                            <div className="flex justify-between text-xs font-bold text-gray-500 mb-1">
                                            ...
                                            <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                                                <div className="h-full bg-google-green w-[42%] rounded-full"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <button onClick={() => setModalOpen(true, 'audit')} className="mt-8 w-full py-4 rounded-xl border border-gray-200 font-bold text-navy-deep hover:bg-gray-50 transition-all">
                                        See Full Case Study
                                    </button>
                                </div>
                            </div>
