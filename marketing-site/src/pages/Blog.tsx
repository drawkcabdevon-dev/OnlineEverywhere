...
const Blog: React.FC = () => {
    ...
    return (
        <div className="bg-background min-h-screen">
            {/* Blog Hero */}
            <section className="relative h-[60vh] min-h-[400px] lg:min-h-[500px] flex items-center overflow-hidden bg-gray-900 border-b border-gray-800">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-6 w-full pt-12">
                    ...
                    <h1 className="text-3xl lg:text-7xl font-display font-bold text-white max-w-4xl tracking-tight leading-tight mb-8">
                        The Psychology of <br className="hidden lg:block" /><span className="text-transparent bg-clip-text bg-gradient-to-r from-google-blue to-google-red">High-Conversion Funnels</span>
                    </h1>
                    <p className="text-lg lg:text-xl text-gray-400 max-w-2xl leading-relaxed mb-10">
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                        <button className="bg-white text-gray-900 hover:bg-google-blue hover:text-white px-8 py-4 rounded-full font-bold transition-all flex items-center gap-2 group shadow-lg hover:shadow-xl hover:scale-105 active:scale-95">
                            Read Article
            ...
            <div className="max-w-7xl mx-auto px-6 py-12 lg:py-24">
                <div className="mb-12 lg:mb-16 flex items-end justify-between border-b border-gray-100 pb-8 relative group">
                    <div>
                        <h2 className="text-google-blue font-bold text-sm uppercase tracking-widest mb-2">Knowledge Base</h2>
                        <h3 className="text-3xl lg:text-4xl font-display font-bold text-navy-deep tracking-tight">Strategic Intelligence</h3>
                    </div>
                    {/* Spicy Color Divider */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 lg:gap-12">
                    {posts.map((post, i) => (
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="bg-white p-6 lg:p-12 rounded-[2rem] lg:rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-2xl hover:translate-y-[-8px] transition-all group lg:min-h-[480px] flex flex-col justify-between cursor-pointer"
                        >
                            <div>
                                <div className="flex justify-between items-start mb-6 lg:mb-10">
                                    <div className="size-14 lg:size-16 rounded-2xl bg-gray-50 flex items-center justify-center text-gray-400 group-hover:text-google-blue group-hover:bg-google-blue/10 transition-all duration-500">
                                        <span className="material-symbols-outlined text-3xl lg:text-4xl">{post.icon}</span>
                                    </div>
                                ...
                                <h2 className="text-2xl lg:text-4xl font-display font-bold text-navy-deep mb-4 lg:mb-6 group-hover:text-google-blue transition-colors leading-tight">
                                    {post.title}
                                </h2>
                                <p className="text-gray-500 text-base lg:text-lg leading-relaxed mb-6 lg:mb-10 line-clamp-3">
                                    {post.excerpt}
                                </p>
                            </div>
