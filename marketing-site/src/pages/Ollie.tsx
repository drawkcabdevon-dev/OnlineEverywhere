        ...
        <div className="pt-24 min-h-screen bg-surface">
            ...
            <section className="relative px-6 lg:px-12 py-20 overflow-hidden">
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <h1 className="text-5xl lg:text-7xl font-display font-bold text-navy-deep leading-tight mb-6">
                            Meet <span className="text-google-blue">Ollie</span>.
                            <br />
                            <span className="text-3xl lg:text-5xl text-gray-400">Your AI Marketing Co-Pilot.</span>
                        </h1>
                        ...
                        <div className="flex flex-wrap gap-4">
                            <button
                                ...
                                className="bg-google-blue text-white px-8 py-4 rounded-xl font-bold hover:bg-blue-600 transition-all shadow-lg hover:shadow-google-blue/30 flex items-center gap-2"
                            >
                            ...
                            <button
                                ...
                                className="bg-white text-navy-deep border border-gray-200 px-8 py-4 rounded-xl font-bold hover:bg-gray-50 transition-all flex items-center gap-2"
                            >
                    ...
                    >
                        ...
                        <div className="relative bg-white rounded-[2.5rem] shadow-2xl border border-gray-100 p-8 overflow-hidden">
                            <div className="flex items-center gap-4 mb-8 border-b border-gray-100 pb-6">
                                <div className="size-16 rounded-2xl bg-google-blue flex items-center justify-center text-white shadow-lg shadow-google-blue/30">
                                    <span className="material-symbols-outlined text-3xl">smart_toy</span>
                                </div>
                                <div>
                                    <h3 className="text-xl font-bold text-navy-deep">Ollie Active State</h3>
            ...
            <section className="py-24 bg-white" id="features">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-20">
                        ...
                        <h3 className="text-4xl font-display font-bold text-navy-deep">What Ollie Does for You.</h3>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={i} className="p-8 rounded-[2rem] border border-gray-100 hover:shadow-xl transition-all hover:-translate-y-1 bg-surface group">
            ...
            <section className="py-24 bg-navy-deep text-white text-center overflow-hidden relative">
                ...
                <div className="relative z-10 max-w-2xl mx-auto px-6">
                    <h2 className="text-4xl lg:text-5xl font-display font-bold mb-8">Ready to hire your AI Co-Pilot?</h2>
